...
public class Parser {
    ...
    public Map<String, Object> unmarshall(byte[] recvBytes) {
        ...
        UUID requestId = UUID.nameUUIDFromBytes(uuidBytes);
    ...
    /**
     * Marshalls the given object into a byte array according to the specified format.
     * 
    ...
    public byte[] marshall(UUID requestId, int serviceId, boolean isRequest, BaseModel item) {
        ...
        // Add UUID
        buffer.put(requestId.toString().getBytes(StandardCharsets.UTF_8), 0, 16);
